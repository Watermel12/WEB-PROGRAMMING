...
$("#addskill").click(function() {
    ...
    $("#skills").append(
        `<span class="badge bg-warning p-2 m-1"> ${skill} <input type='hidden' name='skill[]' value='${skill}'/> <span class="text-black removeskill" onclick='removeskill(this)'>X</span></span>`
    )
    $('#userskill').val('');
});
//add education
