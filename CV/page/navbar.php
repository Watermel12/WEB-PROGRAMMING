...
if($action->user_id())
{
  ?>
            <li class="nav-item">
                <a class="nav-link <?=@$profile?>" href="<?=$action->helper->url('profile')?>"><i
                        class="bi bi-person-workspace"></i> Profile</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?=$action->helper->url('action/logout')?>"><i
